...
export const DESPAIR_FLAVOR_TIERS: { min: number; messages: string[] }[] = [
  {
    ...
    messages: [
      ...
      'Job boards refreshed. Results unchanged.',
      'Employment outlook: structurally yours.',
      'Talent is everywhere. So is everyone else.',
      'Startup culture: free snacks, unpaid overtime.',
      'Remote work available. Office still mandatory.',
      'Economy growing. Your sector: exempt.',
      'Skills gap identified: insufficient gap.',
      'LinkedIn notified. No one replied.',
      'Glassdoor says: mixed reviews. Accurate.',
      'Entry level: 3–5 years experience required.',
      'Open to work badge: on. Offers: off.',
      'Salary band: “depends on experience.” Yours: insufficient.',
      'Posting age: 47 days. Still “actively hiring.”',
      'Unlimited PTO policy. Unlimited guilt included.',
      'We’re a family here. Families fight.',
      'Passion expected. Compensation negotiable (downward).',
    ],
  },
  {
    min: 25,
    messages: [
      ...
      'Application received. Timestamped. Ignored.',
      'Recruiter viewed profile. Then left.',
      'Salary range: competitive (with yourself).',
      'Culture fit analysis: inconclusive.',
      'One-way video interview submitted to void.',
      'Assessment complete. Candidate pool widened.',
      'Thank you for applying. This cycle: closed.',
      'Pipeline updated. Your status: static.',
      'Auto-reply logged. Human review: pending indefinitely.',
      'Resume parsed. Keywords: insufficient.',
      'Reference check complete. References confused.',
      'Background check: your background is fine. Rejected anyway.',
      'Take-home project delivered. No acknowledgment.',
      'Scheduling link expired. New link: unavailable.',
      '“We’ll be in touch.” Touch: not detected.',
      'Rejection email: personalized with your first name.',
    ],
  },
  {
    min: 50,
    messages: [
      ...
      'AI Recruitment reports record engagement.',
      ...
      'Credit score: irrelevant. Applying anyway.',
      'Unpaid case study delivered. Silence returned.',
      'Final round: cancelled for restructuring.',
      'Compensation band: undisclosed until offer.',
      'Performance review: N/A. Unemployed.',
      'Team lunch: you were not invited (no team).',
      'Benefits package: thoughts and prayers.',
      'Equity vesting begins after you leave.',
      'Diversity initiative posted. Headcount frozen.',
      'Mental health days: unpaid, discouraged.',
      'Coffee chat scheduled. Coffee chat ghosted.',
      '“Internal candidate selected.” Always was.',
      'Offer rescinded. Role reposted at lower band.',
      'Panel interview: six people, zero decisions.',
      'Skills test passed. Vibes test failed.',
      'Rejection reason: “pursuing other candidates.” Candidates: unknown.',
    ],
  },
  {
    min: 75,
    messages: [
      ...
      'Outpatient hope discontinued.',
      'Savings rate: negative. Trend: stable.',
      'Survival mode: default operating state.',
      'Response time SLA exceeded. No response.',
      'Burnout detected. Proceeding anyway.',
      'Account flagged: overqualified AND underqualified.',
      'Sleep quality: not a hiring metric.',
      'Support ticket opened. Ticket archived.',
      'Wellness app usage up. Wellness unchanged.',
      'Escalation protocol: none defined.',
      'Rent due. Confidence: overdue.',
      'Loan servicer called. You did not answer.',
      'Interview no-show: them.',
      '“Competitive salary” adjusted for your desperation.',
      'Career coach subscription: auto-renewed.',
      'Inbox zero achieved. Life zero pending.',
    ],
  },
  {
    min: 90,
    messages: [
      ...
      'Hope: 404 error.',
      'MARKET SENTIMENT: VOID',
      'ALL POSITIONS FILLED. NONE FOR YOU.',
      'RESUME ARCHIVED PER GDPR. GOODBYE.',
      'OFFER WITHDRAWN BEFORE EXTENDED.',
      'CERTIFICATE OF PARTICIPATION: REJECTED.',
      'STATUS UPDATE: PERMANENTLY PENDING.',
      'INTERVIEW FEEDBACK: INSUFFICIENT DATA.',
      'NOTIFICATION SUPPRESSED. MOVE ON.',
      'QUEUE POSITION: ∞',
      'APPLICATION WITHDRAWN BY EMPLOYER.',
      'CAREER TRAJECTORY: FLATLINE',
      'UNEMPLOYMENT DURATION: UNDISCLOSED',
      'MATCH SCORE: 98%. HIRED: OTHER CANDIDATE.',
      'SYSTEM NOTICE: YOU HAVE BEEN PROCESSED.',
      'FINAL OUTCOME: TBD (FOREVER)',
      'THANK YOU FOR YOUR INTEREST. INTEREST: DECLINING.',
    ],
  },
];
...
export const AGENCY_ROLE_PROCESSING_MESSAGES = [
  'Parsing job requirements...',
  'Inflating salary band...',
  'Ghosting qualified candidates...',
  'Optimizing req stack...',
  'Selling premium listing...',
  'Running AI shortlist...',
  'Generating false hope...',
  'Billing per posting...',
  'Consulting the talent pipeline...',
...
export const FLOAT_TEXT_EMPLOYER_BAD = [
  ...
  'Touch base with AI Recruitment',
